...
const SignUp = () => {
  ...
  const validateName = () => {
    ...
    if (name.length >100) {
      setNameError('Name length must be 100 characters');
    } else {
      setNameError('');
    }
  };
      ...
      <form className="form" autoComplete="off" onSubmit={handleSubmit}>
        ...
        <div className="inputs">
          ...
          <div className="input">
            ...
            <input type="text" id="address"  placeholder="Enter Address" pattern="^[a-zA-Z0-9\s" value={address} onChange={(e) => setAddress(e.target.value)} required />
